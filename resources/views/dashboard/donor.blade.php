    ...
    <section class="welcome-banner-wrapper">
      <div class="gray-banner">
        <div class="banner-text-content">
          ...
          <p class="donor-id">ID: DNR-2025-0428</p>
        ...
        <button class="top-right-btn">DONOR FORM</button>
...
<div class="checklist-column">
  ...
  <script>
    function contactCoordinator() { alert("Opening email client..."); }

    // Optional: Script to save checklist state in browser memory
